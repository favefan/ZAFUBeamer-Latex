...
\begin{document}
	...
	\begin{frame}
		...
		本模版基于 \hrefcol{mailto:qilong-kirov.liu@outlook.com}{Qilong Liu} 发布的 \hrefcol{https://github.com/liu-qilong/Beamer-LaTeX-Themes}{Beamer-LaTeX-Themes} 中的 深圳环境科学院 SAES Beamer 模版 二次修改制作而成\vspace{\baselineskip}
